...
local browser3          = "/opt/google/chrome/google-chrome --profile-directory=Default --app-id=adnlfjpnmidfimlkaohpidplnoimahfh"
local editor            = os.getenv("EDITOR") or "nano"
local editorgui         = "atom"
local filemanager       = "thunar"
local mailclient        = "/opt/google/chrome/google-chrome --profile-directory=Default --app-id=eppojlglocelodeimnohnlnionkobfln"
...
globalkeys = my_table.join(
    ...
    awful.key({ modkey }, "F3", function () awful.util.spawn( "/opt/google/chrome/google-chrome --profile-directory=Default --app-id=jahnifecgkhjbcbjfkplnplfkcebgafc" ) end,
        {description = "BBC iPlayer" , group = "function keys" }),
    awful.key({ modkey }, "F4", function () awful.util.spawn( "/home/roy/Downloads" ) end,
        {description = "leonflix" , group = "function keys" }),
